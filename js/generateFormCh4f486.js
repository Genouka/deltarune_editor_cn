...
function generateForm(data){
  ...
  formString += "关键信息<br>";
  formString += generateTextInput(`_1`,"文件名",data[`_1`],[{length:10}],'filename');
  formString += generateNumberInput(`_11`,"D$",data[`_11`],{min:0,max:99999},'flag');
  formString += generateSelectCh2(`_3054`,"当前房间",data[`_3054`],rooms,'room_id');
  formString += `<label class='lineItem'><input type="checkbox" name="show_all_rooms" noinput="true"> 显示所有房间</label><br>`

  formString += generateNumberInput(`_3053`,"剧情进度(Story Flag)",data[`_3053`],{min:0,max:211},'flag');

  formString += generateTextboxInput(`_16`,`是否位于暗世界`,data[`_16`],{min:0,max:1},``);
  ...
  formString += "</div>";
    ...
    formString += generateSelectCh2(`_8`,"队员 1: ",data[`_8`],party_members,'party_member_1 grey_disable');
    formString += "<br>";
    formString += generateSelectCh2(`_9`,"队员 2: ",data[`_9`],party_members,'party_member_2 grey_disable');
    formString += "<br>";
    formString += generateSelectCh2(`_10`,"队员 3: ",data[`_10`],party_members,'party_member_3 grey_disable');
    formString += "<br>";

    formString += `<label class='lineItem'><input type="checkbox" name="allow_broken_party" noinput="true">允许选择不可能存在的队员(即允许错误队伍)</label><br>`
    formString += "</div>";
    ...
    formString += "<br><hr>";
    formString += "<div class='spells_title'><center>▼咒语/法术</center></div>";
