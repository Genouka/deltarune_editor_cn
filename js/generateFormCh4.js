...
function generateForm(data){
  ...
  formString += "</div>";
    ...
    formString += "<div id='item_wrapper'>";
    for(var i = 0; i < 8; i++){
      formString += generateSelectCh1(`_${(i*2)+538}`,`槽位 ${i+1}<br>`,data[`_${(i*2)+538}`],phone_numbers,'item_slot grey_disable');
    }
    formString += "</div>";
    formString += "</div>";
    ...
    formString += generateSelectCh2(`_890`,"与 Alvin 对话过",data[`_890`],[{value:0,text:`No`},{value:1,text:`About Gerson or Hammer`},{value:2,text:`About Gerson and Hammer`},{value:3,text:`Heard talking to himself`}],'');
    formString += generateSelectCh2(`_975`,"与 Mettaton 对话过",data[`_975`],[{value:0,text:`No`},{value:1,text:`About Entertainment`}],'');
    formString += generateSelectCh2(`_1014`,"Rudy's Hospital Sink（Rudy在医院的堕落）",data[`_1014`],[{value:0,text:`Not interacted`},{value:1,text:`Interacted`}],'');
    formString += "</div>";
    ...
    formString += "<div id='flags_box'>";
    formString += "过场动画<br>";
    formString += generateSelectCh2(`_861`,"Sans & Toriel 的过场动画",data[`_861`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`}],'');
    formString += generateSelectCh2(`_868`,"Bunker 的过场动画",data[`_868`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`}],'');
    formString += generateSelectCh2(`_869`,"Noelle 在医院的过场动画",data[`_869`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`}],'');
    formString += generateSelectCh2(`_870`,"Dog Jail Break（狗越狱）",data[`_870`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`},{value:2,text:`Jailbreak Tunes`}],'');
    formString += generateSelectCh2(`_894`,"Susie Refuses to go into Diner (Susie 拒绝进入餐厅)",data[`_894`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`}],'');
    formString += generateSelectCh2(`_933`,"打电话给家里",data[`_933`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`}],'');
    formString += "</div>";
    ...
    formString += "<div id='flags_box'>";
    formString += "Onion<br>";
    formString += generateSelectCh2(`_978`,"Did you miss Onion (你是否还记得 Onion)",data[`_978`],[{value:0,text:`No Answer`},{value:1,text:`Yes`},{value:2,text:`No`}],'');
    formString += generateSelectCh2(`_977`,"与 Onion 说过话",data[`_977`],[{value:0,text:`No`},{value:1,text:`Yes`}],'');
    formString += "</div>";
    ...
    formString += "<div id='flags_box'>";
    formString += "Other<br>";
    formString += generateSelectCh2(`_855`,"Ball of Junk（垃圾球）",data[`_855`],[{value:0,text:`Not Gathered`},{value:1,text:`On Head`},{value:2,text:`In Dark World`}],'');
    ...
    formString += `</div>`;
      ...
      formString += generateSelectCh2(`_1460`,"你回答诚实吗？<br>",data[`_1460`],[{value:0,text:`YES`},{value:1,text:`NO`}]);
      formString += generateSelectCh2(`_1461`,"您知道会有疼痛和癫痫发作的可能性。<br>",data[`_1461`],[{value:0,text:`YES`},{value:1,text:`NO`}]);
      ...
      formString += generateSelectCh2(`_808`,"Noelle 在医院的过场动画",data[`_808`],[{value:0,text:`Haven't seen`},{value:1,text:`Watched Cutscene`},{value:2,text:`Talked to Rudy`}],'');
      ...
      formString += generateSelectCh2(`_811`,"与 Onion 说过话",data[`_811`],[{value:0,text:`No`},{value:1,text:`Yes`},{value:2,text:`Became Friend`},{value:3,text:`Refused Friendship`}],'');
      ...
      formString += generateSelectCh2(`_828`,"Rudy's Hospital Sink（Rudy在医院的堕落）",data[`_828`],[{value:0,text:`Not interacted`},{value:1,text:`Interacted`}],'');
